...
<section class="error">
  ...
  <div class="error__content">
    <div class="error__message message">
      ...
      <p class="message__text">Maaf Halaman Yang Anda Tuju Tidak Ada Silahkan Kembali Ke Halaman Sebelumnya</p>
    </div>
    <div class="error__nav e-nav">
      <a href="auth/login" target="_blanck" class="e-nav__link"></a>
    </div>
  </div>
  <!-- END Content -->
