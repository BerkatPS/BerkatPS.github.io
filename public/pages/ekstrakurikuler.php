...
<head>
    ...
    <title>APP KESISWAAN - EKSTRAKURIKULER</title>
</head>
        ...
        <div class="bg-slate-800 w-72 text-purple-600 font-mono focus:outline-none z-20 px-6 py-9 absolute inset-y-0 left-0 transform -translate-x-full transition duration-500 ease-in-out lg:relative lg:translate-x-0" id="sidebar">
            <button href="" title="meta icons" class="mb-[rem] font-extrabold text-2xl text-indigo-500 flex items-center space-x-2">
             ...
             <nav class="text-slate-400 min-h-screen font-mono text-[1.3rem] relative pt-7 gap-3 md:text-lg">
                ...
                <a href="ekstrakurikuler" class="flex items-center text-zinc-300 gap-2 py-2 px-3 my-5 bg-slate-900 rounded-md transition duration-200">
            ...
            <div class="w-full h-[4rem] m-6 p-4 rounded-lg bg-slate-800 text-zinc-300">
                    ...
                    <div class="relative cursor-pointer" x-data="{ isOpen : false }">
                            ...
                            >
                                <div class="absolute flex items-center justify-center top-0 right-0 h-5 w-5 bg-red-700 rounded-full">
                                    <?php $query = $confg->query("SELECT * FROM history_siswa WHERE id_siswa = $_SESSION[userId] OR id_kelas = '$_SESSION[kelas]' AND action = 'MATA PELAJARAN' OR action = 'STATUS PELAJARAN' ORDER BY id DESC")?>
                ...
                <nav class="hidden md:flex py-9" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-3 ">
                        <li class="flex items-center">
                            <span class="font-bold text-2xl">EKSTRAKURIKULER Pages</span>
                        </li>
                        ...
                        <div class="flex items-center">
                            <svg class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                            <span class="ml-1 text-sm font-medium text-gray-400">EKSTRAKURIKULER</span>
                        </div>
                        </li>
                    </ol>
                </nav>
                ...
                <div class="flex items-center justify-center">
                        <input type="search" name="search" class="absolute w-1/2 bg-blue-dark cursor-pointer flex items-center gap-2 rounded-lg focus:bg-blue-600 font-semibold focus:outline-none focus:transform duration-300 focus:text-white   p-3" placeholder="Search in here">
                </div>
                <div class="py-3">
                    
                </div>
                <div class="grid grid-cols-1 sm:grid-cols-2 justify-center gap-5 focus:outline-none">
                    ...
                    <div class="bg-slate-800 w-80 relative grid-cols-1">
                        ...
                        <div class="px-6 py-6 flex items-center justify-center">
                            <button class="w-full p-2 text-green-200  hover:transition duration-300 bg-green-800 hover:text-white"id="blink">Lihat Lainnya</button>
                        </div>
                    </div>
                    <div class="bg-slate-800 w-80 relative grid-cols-1">
                        <div class="flex items-center justify-center py-5 grid-cols-1">
