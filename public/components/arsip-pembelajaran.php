...
<head>
    ...
    <title>APP KESISWAAN - ARSIP PEMBELAJARAN</title>
</head>
                ...
                <div class="relative overflow-x-auto bg-slate-800 shadow-md rounded-lg text-gray-400 pt-7">
                    <div class="header-table">
                        ...
                        <div class="md:flex gap-5 font-medium px-4 pb-5 ">
                            <button class="bg-indigo-500 hover:shadow-lg shadow-indigo-500/50 flex text-white p-2 rounded-lg gap-2 font-medium " onclick="location.href='../App/Rekapitulasi-arsip-pelajaran'"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M3 10h18M3 14h18m-9-4v8m-7 0h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
                                </svg>Rekapitulasi Arsip Pelajaran</button>
                            <button class="bg-red-600 p-2 focus:outline-none font-semibold text-white flex items-center justify-center gap-2 rounded-md hover:shadow-lg hover:shadow-red-600/50 hover:transition hover:duration-300" onclick="window.location.href= 'mata-pelajaran'"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                    ...
                    >
                        ...
                        <tbody>
                        <?php
                        while($row = mysqli_fetch_array($dataArsip)){
                        ?>
                            <tr class="text-center">
                                ...
                                <td class="px-6 py-4 dark:bg-gray-800 font-medium break-words"><a class="hover:text-indigo-500" target="_blank" href="<?=$row['link_virtual']?>"><?=$row['link_virtual']?></a></td>
