...
<head>
    ...
    <title>APP KESISWAAN - REKAPITULASI LAPORAN GURU</title>
</head>
                    ...
                    <div class="relative overflow-x-auto bg-slate-800 overflow-y-auto shadow-md rounded-lg text-gray-400 ">
                        <div class="header-table">
                            <div class="bg-gray-800 p-3">
                                <h1 class="uppercase font-semibold text-slate-200">Rekapitulasi Laporan Guru< Berdasarkan Range Tanggal/h1>
                            </div>
                        </div>
