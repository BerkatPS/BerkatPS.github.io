...
$tbl_development_admin = $confg->query("SELECT * FROM dev_admin ORDER BY id DESC");
             ...
             <nav class="text-slate-400 min-h-screen overflow-y-auto top-0 inset-x-0 font-mono text-[1.3rem] pt-7 gap-3 md:text-lg">
                ...
                <div class="relative" x-data="{ isOpen : false }">
                    ...
                    <div class="relative" x-data="{ isOpen : false }">
                        ...
                        @click="isOpen = !isOpen"
                        href="components/absensi" 
                        class="flex items-center hover:bg-indigo-500 justify-center text-zinc-300 gap-2 py-2 px-3 -inset-x-5  rounded-md transition duration-200">
                    ...
                    <div class="relative" x-data="{ isOpen : false }">
                        ...
                        <div class="relative">
                            ...
                            <!-- Dropdown Menu -->
                                ...
                                x-transition:enter="transition ease-out duration-200" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-200" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95">
                                    <li>
                                        <a href=".soal-ujian" class="flex items-center hover:text-indigo-500 gap-2 transition duration-200 p-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="group-hover:bg-slate-200 fill-current"width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#636e72" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle></svg>
                                        Paket Soal / Ujian</a>
                                    </li>
                                    <li>
                                        <a href="./jadwal-Ujian" class="flex items-center hover:text-indigo-500 gap-2 transition duration-200 p-1">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                        class="group-hover:bg-slate-200 fill-current" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#636e72" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle></svg>
                                        Jadwal Ujian</a>
                                    </li>
                                    <li>
                                        <a href="./rekap-ujian" class="flex items-center hover:text-indigo-500 gap-2 transition duration-200 p-1">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                        class="group-hover:bg-slate-200 fill-current" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#636e72" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle></svg>
                                        Data Ruangan</a>
                                    </li>
            ...
            <div class="relative overflow-x-auto scroll-auto shadow-md bg-slate-800 rounded-lg text-gray-400 pt-5">
                <div class="header-table">
                        <div class="bg-opacity-40">
                            <h1 class="px-4 pb-4 text-lg"><b>DEVELOPMENT PAGES</b></h1>
                            <h2 class="px-4 pb-5">Anda Bisa Melihat Semua Saran Atau Laporan Dari Siswa Maupun Guru</h2>
                        </div>
                        <div class="px-4 pb-5">
                <h1 class="font font-semibold uppercase text-lg">Filter Data Disini</h1>
                </div>
                <div class="px-4 pb-5 flex">
                    <select name="level" id="level" class="flex items-center p-2 w-full bg-transparent border border-slate-500 text-left text-zinc-400 focus:outline-none focus:border-indigo-500 transform translate duration-500">
                        <option class="bg-slate-800" value="">Pilih Level</option>
                        <option class="bg-slate-800" value="Siswa">Siswa</option>
                        <option class="bg-slate-800" value="Guru">Guru</option>
                    </select>
                    <select name="title" id="title" class="flex items-center p-2 w-full bg-transparent border border-slate-500 text-left text-zinc-400 focus:outline-none focus:border-indigo-500 transform translate duration-500">
                        <option class="bg-slate-800"value="">Pilih JUDUL</option>
                        <option class="bg-slate-800"value="LAPORAN BUG">LAPORAN BUG</option>
                        <option class="bg-slate-800"value="SARAN">SARAN</option>
                ...
                <?php 
                    ...
                    ?>
                        ...
                        </svg><span class='font-bold '>&nbspSUCCESS HAPUS DATA&nbspAnda Akan Telah menghapus Data LAPORAN SISWA!! </span>
                        </div>
                    <?php
                    }else{
                    ?>  
                        ...
                        <span class='font-bold'>&nbspGAGAL HAPUS DATA&nbsp</span> Anda GAGAL menghapus Data LAPORAN SISWA!! 
                        </div>
                    <?php
                    }
                }
                ...
                >
                    ...
                    <tbody>
                    <?php
                    while($row = mysqli_fetch_array($tbl_development_admin)){
                    ?>
                        <tr class="text-center">
                            <td class="px-6 py-4 dark:bg-gray-800 font-medium"><?= $row['id'] ?></td>
                            <td class="px-6 py-4 dark:bg-gray-800 font-medium"><?= $row['level'] ?></td>
                            <td class="px-6 py-4 dark:bg-gray-800 font-medium text-indigo-500"><?= $row['username'] ?></td>
                            <td class="px-6 py-4 dark:bg-gray-800 font-medium "><?= $row['title'] ?></td>
                            ...
                            <div class="flex flex-wrap">
                                <td class="py-4 text-sm font-sans font-bold uppercase dark:bg-gray-800 cursor-pointer ">
                                    <div class="relative ">

                                        <a href="Development-view?id=<?= $row['id']?>"class="p-2 gap-1 bg-indigo-500 text-white flex items-center justify-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 gap-2 fill-current" viewBox="0 0 20 20" fill="currentColor">
                                ...
                                <div class="py-4">
                                    <a href="Development-delete?id=<?= $row['id'] ?>" onclick="return confirm('Anda yakin Ingin Menghapus?')"class="p-2 flex items-center justify-center bg-red-600 text-slate-200 ">
