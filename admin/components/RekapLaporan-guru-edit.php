...
$id = $_GET['id'];
$editDataAbsenGuru = $confg->query("SELECT * FROM tbl_laporan_guru WHERE id = $id ");
?>
            ...
            <div class="w-full h-[4rem] m-6 p-4 rounded-lg bg-slate-800 text-zinc-300">
                ...
                <div class="py-3">
                    ...
                    <form action="" class="bg-slate-800 grid grid-cols-1 p-5 py-6 gap-y-12 gap-x-5 mi-h-full relative" method="POST">
                        <h2 class="font-bold text-2xl sm:text-xl"><button class="px-3 py-1 bg-indigo-500 hover:bg-slate-900" onclick="window.location.href='RekapAbsensi-guru'"><</button>&nbspFORM EDIT ABSENSI SISWA</h2>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="hari" class="absolute flex items-center p-2 w-full bg-transparent border border-gray-600 text-left text-zinc-400 focus:outline-none focus:border-indigo-500 transform translate duration-500" placeholder="Masukkan Password Anda" value="<?= $row['nuptk_guru'] ?>">
                        </div>
                        <div class="relative">
                            <label for="">NAMA GURU</label>
                            <input type="text" name="nama_siswa" class="absolute flex items-center p-2 w-full bg-transparent border border-gray-600 text-left text-zinc-400 focus:outline-none focus:border-indigo-500 transform translate duration-500" placeholder="Masukkan Kelas Anda" value="<?= $row['nama_guru'] ?>">
                        </div>
                        <div class="relative">
                            <label for="">KETERANGAN</label>
                            <input type="text" name="kelas_siswa" class="absolute flex items-center p-2 w-full bg-transparent border border-gray-600 text-left text-zinc-400 focus:outline-none focus:border-indigo-500 transform translate duration-500" placeholder="Masukkan Kelas Anda" value="<?= $row['keterangan'] ?>">
                        </div>
                        <div class=""></div>
