                ...
                <div class="relative overflow-x-auto bg-slate-800 shadow-md rounded-lg text-gray-400 pt-5">
                    <div class="header-table">
                        <div class="bg-opacity-40">
                            <h1 class="px-4 pb-5">Data Absensi GURU Berdasarkan Hari Ini <?= date('d F Y') ?></h1>
                        </div>
                <?php 
                    if(isset($_GET['act'])){
                        if($_GET['act'] == "success"){
                    ?>
                        ...
                        </svg><span class='font-bold '>&nbspSUCCESS HAPUS DATA&nbspAnda Akan Telah menghapus Data ABSENSI GURU!! </span>
                ...
                ?>
                    <table class="w-full text-sm text-center text-gray-500 dark:text-gray-400 rounded-lg" id="example">
                        ...
                        <div class="md:flex gap-5 px-4 pb-5">
                            <button class="bg-indigo-500 flex items-center justify-center text-white p-2 rounded-lg gap-2 font-medium " onclick="location.href='../App/Rekapitulasi-absen-guru'"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M3 10h18M3 14h18m-9-4v8m-7 0h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
                            </svg>Rekapitulasi Absensi Guru</button>
                            <button class="bg-green-800 flex items-center justify-center text-base text-white p-2 rounded-lg gap-2 font-medium " onclick="location.href='../App/Rekapitulasi-absen-guru'"><img src="../../icons/excel.png" class="h-8 w-8" alt="" srcset="">Print Melalui Microsoft Excel</button>
                            ...
                            <tr class="text-center relative ">
                                ...
                                <div class="flex flex-wrap">
                                    <td class="py-4 text-base font-medium uppercase dark:bg-slate-800 cursor-pointer ">
                                        <a href="RekapAbsensi-guru-edit?id=<?= $row['id']?>"class="p-2 px-2 bg-indigo-500 text-white">
                                            <span>Edit</span>
                                        </a>
                                    <div class="py-4">
                                        <a href="RekapAbsensi-guru-delete?id=<?= uniqid($row['id']) ?>"onclick="return confirm('Yakin Anda Ingin Menghapus')"class="p-2 px-2 bg-red-600 text-slate-200">
                                            <span>Hapus</span>
                                        </a>
                                    </div>
                                    </td>
