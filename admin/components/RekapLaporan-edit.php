...
$id = $_GET['id'];
$editLaporanGuru = $confg->query("SELECT * FROM tbl_laporan WHERE id = $id ");
?>
...
<head>
    ...
    <title>APP KESISWAAN - EDIT LAPORAN SISWA</title>
</head>
...
<div class="md:flex md:flex-row">
        ...
        <div class="bg-slate-800 w-72 text-purple-600 font-mono focus:outline-none z-20 px-6 py-9 absolute inset-y-0 left-0 transform -translate-x-full transition duration-500 ease-in-out lg:relative lg:translate-x-0" id="sidebar">
            ...
            <div class="w-full h-[4rem] m-6 p-4 rounded-lg bg-slate-800 text-zinc-300">
                ...
                <div class="py-3">
                    <?php
                        while($row = mysqli_fetch_array($editLaporanGuru)){
                    ?>
                    <form action="" class="bg-slate-800 grid grid-cols-1 p-5 py-6 gap-y-12 gap-x-5 mi-h-full relative" method="POST">
                        <h2 class="font-bold text-2xl sm:text-xl"><button class="px-3 py-1 bg-indigo-500 hover:bg-slate-900" onclick="window.location.href='RekapAbsensi-guru'"><</button>&nbspFORM EDIT LAPORAN SISWA</h2>

                        <div class="relative">
                            <label for="">NAMA SISWA</label>
                            <input type="text" name="nama-siswa" class="absolute flex items-center p-2 w-full bg-transparent border border-gray-600 text-left text-zinc-400 focus:outline-none focus:border-indigo-500 transform translate duration-500" placeholder="Masukkan Nama Anda"value="<?= $row['nama'] ?>">
                        </div>
                        <div class="relative">
                            <label for="">NIS SISWA</label>
                            <input type="text" name="nis" class="absolute flex items-center p-2 w-full bg-transparent border border-gray-600 text-left text-zinc-400 focus:outline-none focus:border-indigo-500 transform translate duration-500" placeholder="Masukkan Password Anda" value="<?= $row['NIS'] ?>">
                        </div>
                        <div class="relative">
                            <label for="">JENIS PELANGGARAN</label>
                            <input type="text" name="jenis-pelanggaran" class="absolute flex items-center p-2 w-full bg-transparent border border-gray-600 text-left text-zinc-400 focus:outline-none focus:border-indigo-500 transform translate duration-500" placeholder="Masukkan NIS Anda" value="<?= $row['jenis_pelanggaran'] ?>">
                        </div>
                        <div class="relative">
                            <label for="">POIN</label>
                            <input type="text" name="poin" class="absolute flex items-center p-2 w-full bg-transparent border border-gray-600 text-left text-zinc-400 focus:outline-none focus:border-indigo-500 transform translate duration-500" placeholder="Masukkan Kelas Anda" value="<?= $row['poin'] ?>">
                        </div>
                        <div class="relative">
                            <label for="">TTD SISWA</label>
                            <input type="text" name="ttd-siswa" class="absolute flex items-center p-2 w-full bg-transparent border border-gray-600 text-left text-zinc-400 focus:outline-none focus:border-indigo-500 transform translate duration-500" placeholder="Masukkan Kelas Anda" value="">
                        </div>
                        <div class="relative">
                            <label for="">GURU PELAPOR</label>
                            <input type="text" name="guru-pelapor" class="absolute flex items-center p-2 w-full bg-transparent border border-gray-600 text-left text-zinc-400 focus:outline-none focus:border-indigo-500 transform translate duration-500" placeholder="Masukkan Kelas Anda" value="<?= $row['guru_pelapor'] ?>">
                        </div>
                        <div class="relative">
                            <label for="">TTD GURU PIKET</label>
                            <input type="text" name="ttd-guru-piket" class="absolute flex items-center p-2 w-full bg-transparent border border-gray-600 text-left text-zinc-400 focus:outline-none focus:border-indigo-500 transform translate duration-500" placeholder="Masukkan Kelas Anda" value="">
                        </div>
                        <div class="relative">
                        ...
                        <div class="relative">
                            <label for="">TTD WALI KELAS</label>
                            <input type="text" name="ttd-wali-kelas" class="absolute flex items-center p-2 w-full bg-transparent border border-gray-600 text-left text-zinc-400 focus:outline-none focus:border-indigo-500 transform translate duration-500" placeholder="Masukkan Kelas Anda" value="">
                        </div>
                        <div class=""></div>
