            ...
            <div class="w-full h-[4rem] m-6 p-4 rounded-lg bg-slate-800 text-zinc-300">
                ...
                <div class="relative overflow-x-auto  shadow-md bg-slate-800 rounded-lg text-gray-400 pt-7">
                    <div class="relative px-4 pb-5">
                        <h2 class="uppercase font-bold">Data Mata Pelajaran Berdasarkan Status Selesai</h2>
                    </div>
                    <div class="md:flex gap-5 px-4 pb-5">
                        ...
                        <button class="bg-red-600 p-2 focus:outline-none font-semibold text-white flex items-center justify-center gap-2 rounded-md" onclick="window.location.href= 'jadwalMengajar'"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                        ...
                        ?>
                            <tr class="text-center">
                                ...
                                <div class="flex flex-wrap">
                                    ...
                                    <div class="py-4">
                                        <a href="jadwalMengajar-delete?idMengajar=<?= $row['id'] ?>"onclick="return confirm('Yakin Anda Ingin Menghapus')"class="p-2 px-2 bg-red-700 text-slate-400">
                                            <span>Hapus</span>
                                        </a>
                                    </div>
                                    </td>
