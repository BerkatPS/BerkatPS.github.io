...
$tbl_daftar_pelajaran = $confg->query("SELECT * FROM tbl_pelajaran WHERE status != 'SELESAI'");
            ...
            <div class="w-full h-[4rem] m-6 p-4 rounded-lg bg-slate-800 text-zinc-300">
                ...
                <div class="relative overflow-x-auto  shadow-md bg-slate-800 rounded-lg text-gray-400 pt-7">
                    <div class="relative px-4 pb-5">
                        <h2 class="uppercase font-bold">Data Jadwal Mengajar Hari Ini <?= date('d F Y') ?></h2>
                    </div>
                    <div class="md:flex gap-5 px-4 pb-5">
                        ...
                        <button type="button"type="submit" onclick="window.location.href= 'arsipMengajar'" class="flex items-center uppercase gap-2 font-medium text-white rounded-md p-2 py-2 bg-indigo-500 focus:outline-none hover:shadow-lg shadow-indigo-300/100"><img src="../../icons/eye.png"class="h-5 w-5">Lihat arsip Mengajar</button>
                    </div>
                <div class="px-4 pb-5">
                ...
                <div class="px-4 pb-5 flex">
                    <select name="status" id="" class="flex items-center p-2 w-full bg-transparent border border-slate-500 text-left text-zinc-400 focus:outline-none focus:border-indigo-500 transform translate duration-500">
                        <option class="bg-slate-800"  value="">Pilih Berdasarkan Status</option>
                        <option class="bg-slate-800"  value="MENUNGGU">MENUNGGU</option>
                        <option class="bg-slate-800"  value="BERLANGSUNG">BERLANGSUNG</option>
                        <option class="bg-slate-800"  value="SELESAI">SELESAI</option>
                    </select>
                    <select name="kelas" id="" class="flex items-center p-2 w-full bg-transparent border border-slate-500 text-left text-zinc-400 focus:outline-none focus:border-indigo-500 transform translate duration-500">
                        <option class="bg-slate-800" value="">Pilih Berdasarkan Kelas</option>
                        <?php
                    ...
                    <select name="pelajaran" id="" class="flex items-center p-2 w-full bg-transparent border border-slate-500 text-left text-zinc-400 focus:outline-none focus:border-indigo-500 transform translate duration-500">
                        <option class="bg-slate-800" value="">Pilih Berdasarkan Pelajaran</option>
                        <?php
                            $sql = $confg->query("SELECT list_pelajaran FROM tbl_daftar_pelajaran");
                            while($mata_pelajaran = mysqli_fetch_array($sql)){
                        ?>
                        <option class="bg-slate-800"><?= $mata_pelajaran['list_pelajaran'] ?></option>
                        <?php
                            }
                        ?>
                    </select>
                ...
                ?>
                    <table class="w-full font-bold  text-gray-500 dark:text-gray-400 rounded-lg"
                        id="example"
                    >
                            ...
                            <tr class="text-center">
                                ...
                                <div class="flex flex-wrap">
                                    <td class="py-4 text-base font-medium uppercase dark:bg-gray-800 cursor-pointer ">
                                        <a href="jadwalMengajar-edit?idMengajar=<?= $row['id'] ?>"class="p-2 px-2 bg-indigo-500 text-white">
                                            <span>Edit</span>
                                        </a>
                                    <div class="py-4">
                                        <a href="jadwalMengajar-delete?idMengajar=<?= $row['id'] ?>"onclick="return confirm('Yakin Anda Ingin Menghapus')"class="p-2 px-2 bg-red-600 text-slate-200">
                                            <span>Hapus</span>
                                        </a>
                                    </div>
                                    </td>
